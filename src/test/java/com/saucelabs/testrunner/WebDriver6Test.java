...
public class WebDriver6Test {
    ...
    @Test
    public void webDriver6() throws Exception {
        driver.get("http://www.gutenberg.com/");
        Assert.assertEquals(driver.getTitle(), "Free ebooks - Project Gutenberg");
        passed = true;
     }
