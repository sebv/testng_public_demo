...
public class WebDriver8Test {
    ...
    @Test
    public void webDriver8() throws Exception {
        driver.get("http://www.newyorker.com/");
        Assert.assertEquals(driver.getTitle(), "The Californian");
        passed = true;
     }
